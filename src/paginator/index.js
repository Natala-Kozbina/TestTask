  ...
  return (WrappedComponent) => {
    ...
    class _Paginator extends Component {
      ...
      render() {
        ...
        // paginatorProps.currentPageItems = _currentPageItems || currentPageItems;
        // paginatorProps.currentPageNumber = _currentPageNumber || currentPageNumber;
        // paginatorProps.isNextPageAvailable = _isNextPageAvailable || isNextPageAvailable;
        // paginatorProps.isPrevPageAvailable = _isPrevPageAvailable || isPrevPageAvailable;
        // paginatorProps.pagesQuantity = _pagesQuantity || pagesQuantity;
        // paginatorProps.isLooped = _isLooped || isLooped;
        // paginatorProps.itemsPerPage = _itemsPerPage || itemsPerPage;
        // paginatorProps.totalItemsCount = totalItemsCount;
        // paginatorProps.setPageNumber = this.setPageNumber;
        // paginatorProps.openNextPage = this.openNextPage;
        // paginatorProps.openPrevPage = this.openPrevPage;
        // paginatorProps.setFirstPage = this.setFirstPage;
        // paginatorProps.setLastPage = this.setLastPage;
        // paginatorProps.update = this.update;
